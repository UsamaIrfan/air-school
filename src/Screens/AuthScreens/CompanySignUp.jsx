    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputsContainer}>
         <View style={styles.inputContainer}>
            ...
            <TextInput returnKeyType="next" onSubmitEditing={() => input2.current.focus()} onChangeText={text => setCompanyName(text)} style={styles.input} placeholder="Company Name" />
         </View>
         <View style={styles.inputContainer}>
            <Ionicons style={styles.icon} name="md-person" size={24} color={colors.primary} />
            <TextInput returnKeyType="next" onSubmitEditing={() => input3.current.focus()} ref={input2} onChangeText={text => setTagline(text)} style={styles.input} placeholder="Company Tagline" />
         </View>
         <View style={styles.inputContainer}>
      ...
      <View style={styles.bottonSection}>
         <TouchableOpacity onPress={() => signInAuth()} activeOpacity={0.5} style={styles.button}>
